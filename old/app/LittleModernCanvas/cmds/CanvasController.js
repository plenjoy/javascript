...
module.exports = {
    ...
    fixResizePhotoElement: function(pageIdx) {
        ...
        var imageDetail = require("ImageListManage").getImageDetail(imageId);
        var defaultCrops = require("UtilCrop").getDefaultCrop(currentCanvas.params[0].imageWidth, currentCanvas.params[0].imageHeight, currentCanvas.params[0].width, currentCanvas.params[0].height);
